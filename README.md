...
The terminal is not the best user interface. I am working using PyQt6 to have a GUI, the repository's link is here: <https://github.com/hsingyilai/money-tracker>
